...
- Support auto manifest download via `20770407` / `opensteamtool` / `steamrun` / `wudrm` upstream APIs (default is `20770407`), or a custom Lua endpoint (see [Manifest via Lua](#manifest-via-lua)).
